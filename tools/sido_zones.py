...
# ── 적정물량(분기, 호) ──────────────────────────────────────────────────────
# 기준표 「호갱노노 입주물량」 표 머리의 상수. 이게 국토부 스케일이라는 근거:
# 합계 연 380,000호 vs 국토부 아파트 준공 실적 평균(2011~2025) 연 325,816호 = 0.86배.
# 15년 평균이 적정의 86%면 만성적 소폭 부족 — 기준표 논지와 맞는다.
#
# ⚠️ 상수로 **고정**한다. 서울·경기·인천은 기준표 표에 없어(수도권 50,000 하나뿐)
...
EST = {'서울', '경기', '인천', '세종', '제주'}            # 기준표 표에 없어 추정한 값 — 화면에 표시할 것
...
GRADE_LABS = {'g4': '매우 부족', 'g3': '부족', 'g2': '다소 부족', 'g1': '균형', 'g0': '과잉'}
