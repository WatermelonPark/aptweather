...
LIVEZONE = {
 ...
 '경기북부권':[('경기','의정부시'),('경기','양주시'),('경기','동두천시'),('경기','포천시'),
              ('경기','연천군'),('경기','가평군')],
 '경기서북부권':[('경기','고양시'),('경기','파주시'),('경기','김포시')],
 '경기서부권':[('경기','부천시'),('경기','광명시'),('경기','시흥시'),('경기','안산시')],
 # 화성은 평택과 잔차 상관 0.007로 사실상 무관계인데 옛 '남서부'에 같이 있었다.
 # 수원의 최고 짝이 화성(0.598)이라 남부로 옮기고, 남은 평택·오산(0.573)과
 # 이천·여주(0.641)를 '남부외곽'으로 합쳤다(2026-08-05 사용자 제안·실측 동률).
 '경기남부권':[('경기','수원시'),('경기','안양시'),('경기','과천시'),('경기','의왕시'),
              ('경기','군포시'),('경기','화성시')],
 '경기남부외곽권':[('경기','평택시'),('경기','오산시'),('경기','안성시'),
                ('경기','이천시'),('경기','여주시')],
 '경기동남부권':[('경기','성남시'),('경기','용인시')],
 '경기동부권':[('경기','남양주시'),('경기','구리시'),('경기','하남시'),('경기','광주시'),('경기','양평군')],
}
...
LZ_REGION = {'서울권':'수도권','인천권':'수도권',
 # 경기 8권역도 '수도권'에 넣는다(2026-08-05 사용자) — 따로 빼면 수도권 묶음에
 # 서울·인천 둘만 남는다.
 '경기북부권':'수도권','경기서북부권':'수도권','경기서부권':'수도권','경기남부외곽권':'수도권',
 '경기남부권':'수도권','경기동남부권':'수도권','경기동부권':'수도권',
 '원주권':'강원','춘천권':'강원','강릉권':'강원',
