...
var ZREFNOTE={"un": "미분양은 다 짓고도 팔리지 않아 남아 있는 집입니다(국토교통부 월간 집계). 이미 지어진 재고에 들어 있어 순위 계산에 다시 넣으면 이중계산이라, 참고로만 보여줍니다.", "pm": "인허가는 \"짓겠다\"고 허가받은 단계의 물량으로, 보통 3~4년 뒤 입주로 이어집니다. 실제로 착공하지 않는 계획이 섞여 있어 참고로만 봅니다. 월별 들쭉날쭉이 커서 최근 12개월 합으로 묶어 연간 적정물량과 견주고, 순위 계산에는 착공만 씁니다."};
